        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            for (int i = 1; i < coutEmploee; i++)
            {
                ...
                lEmployees.Add(new Employee(i, AllName[FactoryRandom.Next(0, AllName.Length - 1)],
                    ...
                    new DateTime(DateTime.Now.Year - age, FactoryRandom.Next(1, 12), FactoryRandom.Next(1, 28))));
            }
            modelBuilder.Entity<Employee>().HasData(lEmployees);
            ...
            modelBuilder.Entity<Section>().HasData(new[]
            {
